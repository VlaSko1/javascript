...
const snake = {
  ...
  getNextStepHeadPoint() {
    ...
    const transitionRowsCount = this.config.getRowsCount() - 1;
    const transitionColsCount = this.config.getColsCount() - 1;
    ...
    switch (this.direction) {
      case 'up':
        if (firstPoint.y > 0) {
          ...
          return {x: firstPoint.x, y: transitionRowsCount }
        }
      case 'right':
        if (firstPoint.x < transitionColsCount) {
          return {x: firstPoint.x + 1, y: firstPoint.y};
        } else {
          return {x: 0, y: firstPoint.y};
        }
      case 'down':
        if (firstPoint.y < transitionRowsCount) {
          return {x: firstPoint.x, y: firstPoint.y + 1};
        } else {
      ...
      case 'left':
        if (firstPoint.x > 0) {
          ...
          return {x: transitionColsCount, y: firstPoint.y};
        }   
    }
  },
